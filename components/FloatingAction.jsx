...
export default function FloatingAction() {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-charcoal-medium/90 backdrop-blur-md border-t border-gold-primary/20 px-6 py-3 flex items-center justify-between gap-4 shadow-2xl">
        <a
          href="https://wa.me/918921865894"
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-2 border border-gold-primary/40 text-gold-primary py-2.5 rounded-xl text-xs font-serif uppercase tracking-widest hover:bg-gold-primary/10 transition-colors"
        >
        ...
        <Link
          href="/booking"
          className="flex-1 flex items-center justify-center gap-2 bg-gold-primary text-charcoal-dark py-2.5 rounded-xl text-xs font-serif uppercase tracking-widest font-bold hover:bg-gold-accent transition-colors"
        >
